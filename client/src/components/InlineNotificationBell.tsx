 ...
 * or headers. Shows notifications in a dropdown panel using React Portal.
 */
...
export function InlineNotificationBell({ 
  ...
  // Notification panel rendered via portal to escape card overflow
  ...
  return (
    <>
      ...
      {/* Notifications Panel via Portal */}
      {notificationPanel}
    </>
  );
}
